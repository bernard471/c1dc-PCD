  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/create-payment', {
        ...
        body: JSON.stringify({
          email,
          amount: 10000, // ₵100 in pesewas (Paystack uses the smallest currency unit)
        }),
      });
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-center">
            <p className="text-xs text-gray-400">
              Having trouble? Email us at <a href="mailto:support@cybershield.com" className="text-blue-600 hover:text-blue-500">support@cybershield.com</a>
            </p>
          </div>
        </motion.div>
      </div>
